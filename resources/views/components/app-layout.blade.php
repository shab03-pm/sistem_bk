...
<body class="font-sans antialiased bg-gray-100" x-data="{ sidebarOpen: false }">
    ...
    <!-- Page Header -->
    @if(isset($header))
        <div class="hidden md:block fixed top-0 right-0 left-64 bg-white shadow-md z-30 border-b border-gray-200">
            <div class="px-8 py-8">
                {{ $header }}
            </div>
        </div>
    ...
    <!-- Main Content -->
    <main class="min-h-screen transition-all duration-300 md:ml-64 pt-32 md:pt-8 px-4 sm:px-6 lg:px-8 py-6">
        {{ $slot }}
    </main>
